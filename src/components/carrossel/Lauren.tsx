  ...
  "
    ...
    "
          ...
          <div className="flex gap-4">
            <a href="https://github.com/lauhgabrielle14" target="_blank" className="flex items-center" rel="noopener noreferrer">
              <span className="flex items-center justify-center w-10 h-10">
                <GithubLogoIcon size={28} weight='bold' />
              </span>
            </a>
            <a href="https://www.linkedin.com/in/lauren-fogaca/" target="_blank" className="flex items-center" rel="noopener noreferrer">
              <span className="flex items-center justify-center w-10 h-10">
        ...
        <div className="flex flex-col justify-center items-center w-full gap-4 md:order-1">
          <img
            src="https://ik.imagekit.io/laurengf/DeliveyPet/WhatsApp%20Image%202025-12-03%20at%2010.23.01.jpeg"
            alt="foto Lauren"
