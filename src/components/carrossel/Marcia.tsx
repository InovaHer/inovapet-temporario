  ...
  "
    ...
    "
          ...
          <div className="flex gap-4">
            <a href="https://github.com/MarciaCondarco" target="_blank" className="flex items-center" rel="noopener noreferrer">
              <span className="flex items-center justify-center w-10 h-10">
                <GithubLogoIcon size={28} weight='bold' />
              </span>
            </a>
            <a href="https://www.linkedin.com/in/marciacondarco/" target="_blank" className="flex items-center" rel="noopener noreferrer">
              <span className="flex items-center justify-center w-10 h-10">
        ...
        <div className="flex flex-col justify-center items-center w-full gap-4">
          <img
            src="https://ik.imagekit.io/wvjuanedn/Projeto%20Delivery/Imagens%20Equipe/WhatsApp%20Image%202025-12-03%20at%2010.26.56.jpeg"
            alt="foto marcia"
