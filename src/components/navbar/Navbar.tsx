    ...
    */ 
    ...
    return (
        <>
            ...
            <div className='fixed top-0 left-0 z-50 flex justify-center w-full py-4 text-white bg-green-600 md:py-2'>
            ...
            <img
                    ...
                    <div className='items-center hidden gap-4 py-4 md:flex'>
                        ...
                        <Link to='/usuarios/logar' className='hover:underline flex items-center gap-2'>
                        <UserIcon size={32} weight='bold' />Logar Usuário</Link>
